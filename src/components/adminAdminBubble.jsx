...
function AdminAdminBubble({type, value}) {
    if(type == 'text'){
        return (
            <div className={`p-2 flex flex-row-reverse gap-2 space-x-2`}>
    ...
    if(type == 'image'){
        return(
            <div className={`p-2 flex flex-row-reverse gap-2 space-x-2`}>
                <div className='bg-black w-8 h-8 items-center p-1 rounded-full'>
                    <img src={logo} alt="" className='w-6 h-6' />
                </div>
                <div className='bg-notblack  max-w-[70vw] rounded-xl p-2'>
...
export default AdminAdminBubble
